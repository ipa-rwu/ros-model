...
public class ProcessImpl extends MinimalEObjectImpl.Container implements system.Process {
     ...
     * @ordered
     */
    protected EList<AbstaractComponent> nodes;
     ...
     */
    @Override
    public EList<AbstaractComponent> getNodes() {
        if (nodes == null) {
            nodes = new EObjectContainmentEList<AbstaractComponent>(AbstaractComponent.class, this, RossystemPackage.PROCESS__NODES);
        }
        return nodes;
    }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case RossystemPackage.PROCESS__NODES:
                getNodes().clear();
                getNodes().addAll((Collection<? extends AbstaractComponent>)newValue);
                return;
        }
