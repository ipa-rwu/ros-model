...
:
(
    { before(grammarAccess.getPackageSetAccess().getPackageAssignment_1()); }
    (rule__PackageSet__PackageAssignment_1)*
    { after(grammarAccess.getPackageSetAccess().getPackageAssignment_1()); }
)
;
finally {
    restoreStackSize(stackSize);
...
:
    (
        ...
        rulePackage_Impl
        { after(grammarAccess.getPackageSetAccess().getPackagePackage_ImplParserRuleCall_1_0()); }
    )
;
finally {
    restoreStackSize(stackSize);
