...
public class RosParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RosGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCatkinPackageAccess().getGroup_7(), "rule__CatkinPackage__Group_7__0");
			builder.put(grammarAccess.getCatkinPackageAccess().getGroup_7_1(), "rule__CatkinPackage__Group_7_1__0");
			...
			builder.put(grammarAccess.getAmentPackageAccess().getGroup_5_3(), "rule__AmentPackage__Group_5_3__0");
			...
			builder.put(grammarAccess.getAmentPackageAccess().getGroup_7_1(), "rule__AmentPackage__Group_7_1__0");
			...
			builder.put(grammarAccess.getPackage_ImplAccess().getSpecAssignment_5_3_1(), "rule__Package_Impl__SpecAssignment_5_3_1");
			builder.put(grammarAccess.getPackage_ImplAccess().getArtifactAssignment_6_0(), "rule__Package_Impl__ArtifactAssignment_6_0");
			builder.put(grammarAccess.getPackage_ImplAccess().getArtifactAssignment_6_1_1(), "rule__Package_Impl__ArtifactAssignment_6_1_1");
			...
			builder.put(grammarAccess.getCatkinPackageAccess().getDependencyAssignment_5_2(), "rule__CatkinPackage__DependencyAssignment_5_2");
			builder.put(grammarAccess.getCatkinPackageAccess().getDependencyAssignment_5_3_1(), "rule__CatkinPackage__DependencyAssignment_5_3_1");
			builder.put(grammarAccess.getCatkinPackageAccess().getSpecAssignment_6_2(), "rule__CatkinPackage__SpecAssignment_6_2");
			builder.put(grammarAccess.getCatkinPackageAccess().getSpecAssignment_6_3_1(), "rule__CatkinPackage__SpecAssignment_6_3_1");
			builder.put(grammarAccess.getCatkinPackageAccess().getArtifactAssignment_7_0(), "rule__CatkinPackage__ArtifactAssignment_7_0");
			builder.put(grammarAccess.getCatkinPackageAccess().getArtifactAssignment_7_1_1(), "rule__CatkinPackage__ArtifactAssignment_7_1_1");
			...
			builder.put(grammarAccess.getAmentPackageAccess().getDependencyAssignment_5_2(), "rule__AmentPackage__DependencyAssignment_5_2");
			builder.put(grammarAccess.getAmentPackageAccess().getDependencyAssignment_5_3_1(), "rule__AmentPackage__DependencyAssignment_5_3_1");
			builder.put(grammarAccess.getAmentPackageAccess().getSpecAssignment_6_2(), "rule__AmentPackage__SpecAssignment_6_2");
			builder.put(grammarAccess.getAmentPackageAccess().getSpecAssignment_6_3_1(), "rule__AmentPackage__SpecAssignment_6_3_1");
			builder.put(grammarAccess.getAmentPackageAccess().getArtifactAssignment_7_0(), "rule__AmentPackage__ArtifactAssignment_7_0");
			builder.put(grammarAccess.getAmentPackageAccess().getArtifactAssignment_7_1_1(), "rule__AmentPackage__ArtifactAssignment_7_1_1");
